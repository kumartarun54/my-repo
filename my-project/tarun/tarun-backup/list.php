                     ...
                     <?php //echo "<pre>"; print_r($list);
                        ...
                        <tr>
                          ...
                          <td>
                              ...
                              <td></td>
                              <td>
                               <a href="#" class="tbl-btn"> <i class="fa fa-signal" aria-hidden="true" alt="Reports" title="Reports" onclick="location='<?php echo  base_url(); ?>userinfo?id = <?php echo $value->id;?>'"></i></a>
                                &nbsp;
